...
def add_parser(subparsers):
    ...
    parser_import_problem_from_folder.\
        add_argument('directory', help='The directory that is going to be imported. '
                                       'It has to contain `src` and `solutions` folders')
    parser_import_problem_from_folder.\
        set_defaults(func=lambda options: process_import_problem_from_folder(options.directory))
